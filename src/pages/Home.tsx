    ...
    <div className="space-y-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="h-64 rounded-2xl bg-gradient-to-br from-purple-900 to-purple-600 relative overflow-hidden group cursor-pointer border border-purple-500/30">
          <div className="absolute inset-0 flex items-center justify-center text-purple-200/20 text-4xl font-bold text-center">
             PLACE IMAGE HERE <br/> (Crash Heating Up)
          </div>
        </div>
      </section>
      ...
      {/* SECTION 3: GAME GRID (Square Grid) */}
      <section>
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold flex items-center gap-2">
            🔥 {activeTab === 'All Games' ? 'Trending Games' : `All ${activeTab}`}
          </h2>
          {/* Arrows have been completely removed from here */}
        </div>
        
        {/* Grid dynamically maps over the 'displayedItems' array */}
